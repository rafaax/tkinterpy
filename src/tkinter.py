...
class Tkinter(object):
    ...
    def buscaEquipamentoID(self, cursor, placa):
    ...
    def compararData(self, data, now):
    ...
    def close_loading(self, loading_page):
        loading_page.destroy()



    def main_query(self, progress_bar, cursor, equipament_id, data):
    ...
    def salvar_csv(self, results, placa, equipament_id, data):
    ...
    def buscar_charset(self, filename):
    ...
    def csv_para_excel(self, df, placa, equipament_id, data):
    ...
    def dialogo_salvar_arquivo(self, wb):
    ...
    def ajustar_colunas(self, filename):
